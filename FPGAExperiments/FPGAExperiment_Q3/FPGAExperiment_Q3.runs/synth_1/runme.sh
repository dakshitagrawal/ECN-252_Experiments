...
HD_PWD='C:/Users/eict/Desktop/Deep/swap/swap.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log swap_file.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source swap_file.tcl
