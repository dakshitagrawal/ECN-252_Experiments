...
HD_PWD='C:/Users/eict/Desktop/Deep/swap/swap.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log swap_file.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source swap_file.tcl -notrace
